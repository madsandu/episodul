...
class WC_CP_Admin {
	...
	public function component_layout_hide_product_title( $id, $data, $product_id ) {
		...
		<div class="component_hide_selection_title group_hide_product_title">
			<div class="form-field">
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Check this option to hide the selected product title.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public function component_layout_hide_product_description( $id, $data, $product_id ) {
		...
		<div class="component_hide_selection_description group_hide_product_description" >
			<div class="form-field">
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Check this option to hide the selected product description.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public function component_layout_hide_product_thumbnail( $id, $data, $product_id ) {
		...
		<div class="component_hide_selection_thumbnail group_hide_product_thumbnail" >
			<div class="form-field">
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Check this option to hide the selected product thumbnail.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public function composite_pricing_options() {
		...
		// Price.
		woocommerce_wp_text_input( array( 'id' => '_base_regular_price', 'class' => 'short', 'label' => __( 'Base Regular Price', 'woocommerce-composite-products' ) . ' (' . get_woocommerce_currency_symbol() . ')', 'data_type' => 'price', 'desc_tip' => true, 'description' => __( 'Base regular/sale price of the Composite, added on top of the regular/sale price of all selected Components.' ) ) );
	...
	public function composite_stock_info() {
		...
		<p class="form-field show_if_composite composite_stock_msg">
			...
			<span class="note"><?php _e( 'Use these settings to enable stock management at composite level' ); ?>
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'By default, the sale of a product within a composite has the same effect on its stock as an individual sale. There are no separate inventory settings for composited items. However, this pane can be used to enable stock management at composite level. This can be very useful for allocating composite stock quota, or for keeping track of composited item sales.', 'woocommerce-composite-products' ) ); ?>
			</span>
		</p><?php
