...
class WC_CP_Helpers {
	...
	public static function extend_price_display_precision() {
		add_filter( 'option_woocommerce_price_num_decimals', array( __CLASS__, 'get_wc_rounding_precision' ) );
	}
	...
	public static function reset_price_display_precision() {
		remove_filter( 'option_woocommerce_price_num_decimals', array( __CLASS__, 'get_wc_rounding_precision' ) );
	}

	/**
	 * Returns the internal WC rounding precision.
	 *
	 * @return int
	 */
	public static function get_wc_rounding_precision() {
		return WC_ROUNDING_PRECISION;
	}
